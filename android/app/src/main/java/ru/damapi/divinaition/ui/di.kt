...
import ru.damapi.divinaition.ui.profile.ProfileViewModel
...
val domainModule = module {
    ...
    factory<EditUsernameUseCase> { EditUsernameUseCase(get()) }
}
...
val appModule = module {
    ...
    viewModel<ProfileViewModel> { ProfileViewModel(getCurrentUserUseCase = get(), get()) }
}
